...
The confidence interval is (93.96, 102.92). Therefore, we're 90 percent confident that the true mean will fall within the interval of (93.96, 102.92).	
	...
	\begin{itemize}
		...
		\lstinputlisting[language=R, firstline=74, lastline=76]{PS1_Answer.R}  
		\vspace{.5cm}
		...
		\lstinputlisting[language=R, firstline=77, lastline=79]{PS1_Answer.R}  
		\vspace{.5cm}
		...
		\vspace{.5cm}
			\lstinputlisting[language=R, firstline=82, lastline=82]{PS1_Answer.R}  
		\vspace{.5cm}
		...
		\vspace{.5cm}
		\lstinputlisting[language=R, firstline=86, lastline=89]{PS1_Answer.R}  
		\vspace{.5cm}
